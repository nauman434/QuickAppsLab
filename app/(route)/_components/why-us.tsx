...
const WhyUs = () => {
    return (
        <div>
            <div className="pt-[80px] w-full bg-transparent flex flex-col items-center justify-center overflow-hidden rounded-md">
                <h2 className='text-center md:text-[80px] text-[40px] font-bold font-syne md:w-[70vw] w-full text-primary'>Why Choose Us?</h2>
            ...
            <Container className='pb-[80px] flex flex-col justify-start items-center gap-10'>
                <div className='grid md:grid-cols-2 grid-cols-1 gap-6 w-full'>
                    <div className='flex flex-col gap-6'>
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4'>
                                <h4 className='sm:sm:text-[36px] text-2xl  font-syne font-bold text-primary'>Tailored Solutions</h4>
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4'>
                                <h4 className='sm:text-[36px] text-2xl font-syne font-bold text-primary'>Expert Team</h4>
                    ...
                    <div className='flex flex-col gap-6 '>
                        ...
                        >
                            <div className='flex flex-col gap-4'>
                                <h4 className='sm:text-[36px] text-2xl font-syne font-bold text-primary'>Save Time and Reduce Errors</h4>
                        ...
                        >
                            ...
                            <div className='flex flex-col gap-4'>
                                <h4 className='sm:text-[36px] text-2xl font-syne font-bold text-primary'>Comprehensive Support</h4>
