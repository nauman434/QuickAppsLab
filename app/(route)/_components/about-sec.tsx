            ...
            <div className='bg-secondary-navy sm:py-[95px] py-[55px] sm:px-[65px] px-[35px] rounded-[50px]'>
                ...
                <div className='flex md:flex-row flex-col gap-8 md:items-center items-start justify-between'>
                    ...
                    <p className='md:text-[20px] text-[16px] text-muted-sky md:w-[631px] w-full'>
                        At Quickapps Labs, we specialize in creating custom integrations that effortlessly connect your business apps with Quickapps Labs. Our mission is to simplify your financial management, giving you more time to focus on what really matters—growing your business.
                    </p>
                </div>
            </div>
        </Container>
